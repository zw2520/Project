...
# Define the colors for different situations
class bcolors:
    HEADER = '\033[95m'
    OKBLUE = "\033[94m"
    OKGREEN = '\033[92m'
...
class Person:
    ...
    def choose_magic(self):
        i = 1
        print(bcolors.OKGREEN + bcolors.BOLD + "    Magics:" + bcolors.ENDC)
    ...
    def get_stats(self):
        ...
        # keep the format with less digit
        hp_str = str(self.hp) + "/" + str(self.maxhp)
        current_hp = ''
    ...
    def choose_enemy_spell(self):
        ...
        if self.mp < spell.cost or spell.type_ == "white" and pct > 50:
